const Subscribe = () => {
  return (
    ...
    <main className="flex items-center justify-center h-screen bg-zinc-700 text-white">
      {/* Card */}
      <div className="bg-zinc-800 mx-10 p-2 rounded-2xl">
        {/* Flex container */}
        <div className="flex flex-col md:flex-row rounded-l-xl">
          {/* Image */}
          {/* <Image
            className="object-fit rounded-xl h-80 md:h-64 md:rounded-l-xl md:rounded-r-none transition hover:scale-105 hover:rounded-xl duration-200"
            src="/images/img1.jpg"
            alt=""
            width={200}
            height={320}
          /> */}
          <img
            className="object-fit rounded-xl h-72 md:h-64 md:rounded-l-xl md:rounded-r-none transition hover:scale-105 hover:rounded-xl duration-200"
            src="/images/img1.jpg"
            alt="Image"
          />
          {/* content */}
